        ...
        private Escolares retEsc(String[] dat) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        ps=c.getString(4);
                esc = new Escolares(id,n,ap,am,ps);
            }
            c.close();
            return esc;
        }
        ...
        private JefeDepartamento retJefeDep(String[] dat) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        ps=c.getString(4);
                jd = new JefeDepartamento(id,n,ap,am,ps);
            }
            c.close();
            return jd;
        }
        ...
        private JefeAcademia retJefeAc(String[] dat) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        ps=c.getString(4);
                ja = new JefeAcademia(id,n,ap,am,ps);
            }
            c.close();
            return ja;
        }
        ...
        private Coordinador retCoord(String[] dat) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        ps=c.getString(4);
                coo = new Coordinador(id,n,ap,am,ps);
            }
            c.close();
            return coo;
        }
        ...
        private Maestro retMaestro(String[] dat) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        ps=c.getString(4);
                ma = new Maestro(id,n,ap,am,ps);
            }
            c.close();
            return ma;
        }

        private Alumno retAlumno(String[] dat){
            Alumno al = null;
            Cursor c = myDataBase.rawQuery(
        ...
        private Coordinador retCoord(int anInt) {
            ...
            if( c.moveToLast() ){
                ...
                String n=c.getString(1),
                        ...
                        am=c.getString(3),
                        p=c.getString(4);
                coo = new Coordinador(id,n,ap,am,p);
            }
            c.close();
            return coo;
        }
